...
png("../figures/figure9_clt_demonstration.png", 
   width = 10, height = 6, units = "in", res = 300)

par(mfrow = c(1, 2))

# Original distribution
hist(eda_df$lactate_value_num, breaks = 50, 
     main = "Original Lactate Distribution (Right-skewed)",
     xlab = "Lactate (mmol/L)", 
...
hist(sample_means, breaks = 50,
     ...
     xlab = "Sample Mean Lactate (mmol/L)",
     col = "coral", border = "white")
curve(dnorm(x, mean = mean(sample_means), sd = sd(sample_means)) * 
        length(sample_means) * diff(range(sample_means))/50,
...
## Conclusions of Statistical Inference analysis
