...
prop.table(table(ifelse(ml_df$gender == 'F', 0, 1)))*100
```


```{r}
# Proportion table by lactate_flag 0=normal, 1=abnormal
prop.table(table(ifelse(ml_df$lactate_flag == 'normal', 0, 1)))*100
```


```{r}
# Proportion table by bilirubin_flag 0=normal, 1=abnormal
prop.table(table(ifelse(ml_df$bilirubin_flag == 'normal', 0, 1)))*100
```


```{r}
# Proportion table by ck_flag 0=normal, 1=abnormal
prop.table(table(ifelse(ml_df$ck_flag == 'normal', 0, 1)))*100
```


```{r}
# Proportion table by icu_dead 0=alive, 1=dead
prop.table(table(ml_df$icu_dead))*100
```
